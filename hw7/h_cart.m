...
%
   ...
   dely2sq = dely2^2;
   h = zeros(2,1);
   h(1,1) = sqrt(dely1asq + dely2sq); % m
   h(2,1) = sqrt(dely1bsq + dely2sq); % m
%
...
%
   ...
   dh_dx(1,:) = [0, ...
       -dely1a*(dely1asq + dely2sq)^(-1/2), ...
        dely2*(dely1asq + dely2sq)^(-1/2), ...
       0, 0];
%
   one_over_rhob = 1/h(2,1);

   dh_dx(2,:) = [0, ...
       -dely1b*(dely1bsq + dely2sq)^(-1/2), ...
        dely2*(dely1bsq + dely2sq)^(-1/2), ...
       0, 0];
