...
% 
%  This function does Newton estimation of the initial
...
%
%                   3   Did not have a positive definite cost Hessian
%                       on the most recent iteration.  It is very
%                       questionable that this is the optimal
%                       estimate.
%
...
%
   ...
   delxsizetest = norm(delxnewton) < 1.e-09*(1 + norm(xguess));
   itermflag = 0;
   if delJsizetest & delxsizetest & (iflagHess == 0)
      xest = xguess;
      Jopt = J;
      return
   end
...
%
   while testdone == 0
      alpha = 1;
      xguessnew = xguess + alpha*delxnewton;
      Jnew = jdxnewtonmissle(xguessnew,thist,zhist,lradar,...
...
%
      ...
      if alphatest & delJratiotest & delxsizetest & (iflagHess == 0) & ...
            (iflagHessold == 0)
         testdone = 1;
      end
