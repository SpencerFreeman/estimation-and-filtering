function [xerr_mean,P_GN,P_CRLB,Ptypapprox] = ...
...
%                simulations.
%
%    P_GN        The 4x4 Mean-Square estimation error matrix (includes
...
%
%    Ptypapprox  A typical Gauss-Newton approximation of the
