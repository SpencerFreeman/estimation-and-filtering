function [xtruehist,zhist] = kf_truthmodel_midterm(F,Gamma,H,Q,R,xhat0,...
                                           P0,kmax)
%
...
%
Q_chol = chol(Q); % ANSWER
R_chol = chol(R); % ANSWER
%
...
%
   ...
   for k = 1:kmax
      xkm1 = xk;
      vkm1 = Q_chol' * randn(nv, 1); % ANSWER
      xk = F*xkm1 + Gamma*vkm1;
      wk = R_chol' * randn(nz, 1); % ANSWER
      zk = H*xk + wk;
      kp1 = k + 1;
      xtruehist(kp1,:) = xk';
      zhist(k,:) = zk';
